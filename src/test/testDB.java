...
public class testDB {
	...
	public static void main(String args[]) {
		...
		//
		// System.out.println("Il drop ha impiegato " + (endDrop - startDrop) / 1000 + "
		// secondi");
		//
		// // CREATE
		//
		...
		// dbManager.getUtenteDao().aggiungiProdottoInPreferiti(6,
		// "francmarrara@gmail.com");
		// dbManager.getUtenteDao().aggiungiProdottoInPreferiti(7,
		// "francmarrara@gmail.com");
		// dbManager.getUtenteDao().aggiungiProdottoInPreferiti(8,
		// "francmarrara@gmail.com");
		...
		//
		//
		// List<ProdottoConImmagini> prodotti =
		// dbManager.getProdottoDao().prodottiInOfferta();
		//
