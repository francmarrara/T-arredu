        ...
        <body>
            ...
            <div class="jumbotron">
                ...
                <div id="wowslider-container1">
                    <div class="ws_images">
                        <ul>
                            <li><img src="data1/images/arke.jpg" alt="Arke" title="Arke" id="wows1_0" /></li>
                            <li><img src="data1/images/fina.jpg" alt="Fina" title="Fina" id="wows1_1" /></li>
                            <li><img src="data1/images/medolla.jpg" alt="Medolla" title="Medolla" id="wows1_2" /></li>
                            <li><img src="data1/images/bastiglia.jpg" alt="Bastiglia" title="Bastiglia" id="wows1_3" /></li>
                            <li>
                                <a href="http://wowslider.net"><img src="data1/images/rivo.jpg" alt="javascript image slider" title="Rivo" id="wows1_4" /></a>
                            </li>
                            <li><img src="data1/images/terra.jpg" alt="Terra" title="Terra" id="wows1_5" /></li>
                        </ul>
                    </div>
                    <div class="ws_bullets">
                        <div>
                            <a href="prodotto.html" title="Arke"><span><img src="data1/tooltips/arke.jpg" alt="Arke"/>1</span></a>
                            <a href="prodotto.html" title="Fina"><span><img src="data1/tooltips/fina.jpg" alt="Fina"/>2</span></a>
                            <a href="prodotto.html" title="Medolla"><span><img src="data1/tooltips/medolla.jpg" alt="Medolla"/>3</span></a>
                            <a href="prodotto.html" title="Bastiglia"><span><img src="data1/tooltips/bastiglia.jpg" alt="Bastiglia"/>4</span></a>
                            <a href="prodotto.html" title="Rivo"><span><img src="data1/tooltips/rivo.jpg" alt="Rivo"/>5</span></a>
                            <a href="prodotto.html" title="Terra"><span><img src="data1/tooltips/terra.jpg" alt="Terra"/>6</span></a>
                        </div>
                    </div>
                ...
                <div class="row prodottiInOfferta">
                    <div class="col-sm-4">
                        <div class="coupon">
                            ...
                            <img class="immagineProdottoInOfferta" src="images/productImages/Ardiano_01.jpg" alt="Divano Ardiano">
                            ...
                            <div class="containerPrezzoEData">
                                <p>Prezzo: <span class="prezzo">----$</span></p>
                                <button type="button" class="btn btn-default bottoneProdottoInOfferta"><a href="prodotto.html"></span> Mostra</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="coupon">
                            ...
                            <img class="immagineProdottoInOfferta" src="images/productImages/TerraR04_01.jpg" alt="Stanza TerraR04">
                            <div class="containerTitoloETesto">
                                <div class="titoloArticoloInOfferta">
                                    <h4>TITOLO 1</h4>
                                    <p>Lorem ipsum dolor sit amet, et nam pertinax gloriatur. Sea te minim soleat senserit, ex quo luptatum tacimates voluptatum.</p>
                    ...
                    <div class="col-sm-4">
                        <div class="coupon">
                            ...
                            <img class="immagineProdottoInOfferta" src="images/productImages/Sunrise_01.jpg" alt="Letto Sunrise">
                            <div class="containerTitoloETesto">
                                <div class="titoloArticoloInOfferta">
                                    <h4>TITOLO 1</h4>
                                    <p>Lorem ipsum dolor sit amet, et nam pertinax gloriatur. Sea te minim soleat senserit, ex quo luptatum tacimates voluptatum.</p>
                ...
                <div class="row prodottiPiuVisti">
                    <div class="col-sm-4">
                        <div class="couponPiuVisto">
                            <img class="immagineProdottoPiuVisto" src="images/productImages/Ardiano_01.jpg" alt="Divano Ardiano">
                            <div class="containerTitoloETesto">
                                <div class="titoloArticoloPiuVisto">
                                    <h4>TITOLO 1</h4>
                                </div>
                            </div>
                            <button type="button" class="btn btn-default bottoneProdottoPiuVisto"><a href="prodotto.html"></span> Mostra</a></button>

                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="couponPiuVisto">
                            <img class="immagineProdottoPiuVisto" src="images/productImages/TerraR04_01.jpg" alt="Stanza TerraR04">
                            <div class="containerTitoloETesto">
                                <div class="titoloArticoloPiuVisto">
                                    <h4>TITOLO 1</h4>
                                </div>
                    ...
                    <div class="col-sm-4">
                        <div class="couponPiuVisto">
                            <img class="immagineProdottoPiuVisto" src="images/productImages/Sunrise_01.jpg" alt="Letto Sunrise">
                            <div class="containerTitoloETesto">
                                <div class="titoloArticoloPiuVisto">
                                    <h4>TITOLO 1</h4>
                                </div>
            ...
            <footer id="myFooter">
                ...
                <div class="social-networks">
                    ...
                    <a href="http://www.facebook.com/sharer.php?u=index.jsp" class="facebook"><i class="fa fa-facebook-official"></i></a>
                    <a href="www.googleplus.com" class="google"><i class="fa fa-google-plus"></i></a>
                </div>
            </footer>
        </body>
