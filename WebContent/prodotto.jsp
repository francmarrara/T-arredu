...
<body>
        ...
        <div class="row" id="">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/productImages/Ardiano_01.jpg" alt="Ardiano Pic 1">
                        ...
                        <div class="item">
                            <img src="images/productImages/Ardiano_02.jpg" alt="Ardiano Pic 2'">
                            <div class="carousel-caption">
                        ...
                        <div class="item">
                            <img src="images/productImages/Ardiano_03.jpg" alt="Ardiano Pic 3'">
                            <div class="carousel-caption">
                            </div>
                        </div>
            ...
            <div class="col-md-5 single-top-right descrizione">
                ...
                <div class="btn-group button_favoriti">
                    <button type="button" class="btn btn-danger" title="Aggiungi ai favoriti">
    ...
    <div class="container menu_basso" style="background-color: aliceblue">
        <div class="col-md-9 single-top-left ">
            <ul class="nav nav-tabs menu_down">
                ...
                <li><a data-toggle="tab" href="#aggiungiRecensione">Aggiungi una recensione!</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="venditori" class="tab-pane fade">
                    ...
                    <ul class="lista_venditori">
                        <li><a href="venditore.html">Venditore 1</a></li>
                        <li><a href="venditore.html">Venditore 2</a></li>
                        <li><a href="venditore.html">Venditore 3</a></li>
                        <li><a href="venditore.html">Venditore 4</a></li>
                    </ul>
                </div>
    ...
    <!--End Single Product Div Everything-->
