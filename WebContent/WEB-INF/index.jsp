	...
	<c:if test="${passwordCorretta == false}">
				...
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav navbar-right menuDestra">
						...
						<c:if test="${utenteLoggato == true}">
							...
							<li class="navbarOggetto"><a href="utente"
								class="nomeUtente"><span
						...
						<c:if test="${utenteLoggato == false  || empty utenteLoggato}">
							...
							<li class="carrello navbarOggetto"><a
								onclick="chiediLogin()" style="cursor: pointer"><span
									class="glyphicon glyphicon-shopping-cart"></span> Carrello</a></li>
						</c:if>
		...
		<footer id="myFooter">
			...
			<div class="social-networks">
				<a href="" id="tw_share" class="twitter"><i
					class="fa fa-twitter"></i></a> <a href="" id="fb_share"
					class="facebook"><i class="fa fa-facebook-official"></i></a> <a
					href="" id="go_share" class="google"><i
