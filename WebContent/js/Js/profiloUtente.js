...
$(document).on("focusout", "#confirmNewPassword", function() {
    ...
    if (password == confirmPassword && password != oldPassword) {
        $("#newPassword").css({ 'background-color': '#7FFF00' });
        $("#confirmNewPassword").css({ 'background-color': '#7FFF00' });
        ...
        $("#confirmNewPassword").css({ 'background-color': 'red' });
...
//        $("#oldPassword").css({ 'background-color': '#7FFF00' });
//     
//        $("#snackbar").css({ 'background-color': '#7FFF00' });
//        $("#snackbar").text("LA PASSWORD E' CONFERMATA");
//        showSnackbar();
//
//    } else {
//        $("#oldPassword").css({ 'background-color': 'red' });
