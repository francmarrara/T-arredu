...
$("#snackbar").text("PER EFFETTUARE QUESTA AZIONE DEVI ESSERE REGISTRATO ED EFFETTUARE IL LOGIN");
    ...
    //controllo che il prodotto non sia già in preferiti
         success: function(data) {
             if (data == "true") {
               ...
               // se non è in preferiti faccio un altra chiamata ajax e lo aggiungo
            	 $.ajax({
                     type: "GET",
